        ...
        <form class="form-horizontal" action="{{ url('install/verify-envato-purchase-code?old=' . $old) }}" method="post">
			...
			<div class="form-group">
				<div class="col-md-8 input-field offset-2">
					...
					<input type="text" class="form-control" id="envatoUsername" name="envatoUsername" placeholder="Enter Anything" value="{{ old('envatoUsername') }}" required>
					@if(isset($errors))
			...
			<div class="form-group">
				<div class="col-md-8 input-field offset-2">
					...
					<input type="text" class="form-control" id="envatopurchasecode" placeholder="Enter Anything" name="envatopurchasecode" required>
					@if(isset($errors))
